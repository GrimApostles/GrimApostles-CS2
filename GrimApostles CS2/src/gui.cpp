...
void gui::renderPlayers(CGame game) {
	for (int i = 1; i <= 64; i++) {
		...
		if (angle <= 3.14159265f && angle >= 0) {
			textPos = ImVec2(windowPos.x + x - (textSize.x / 2), (windowPos.y + y) + textOffset);
		}
		else {
			textPos = ImVec2(windowPos.x + x - (textSize.x / 2), (windowPos.y + y) - 2.25 * textOffset);
		}
...
void gui::loadTextures() {
	maps::mapTextures["cs_italy"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\cs_italy_radar.png");
	maps::mapTextures["cs_office"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\cs_office_radar.png");
	maps::mapTextures["de_ancient"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_ancient_radar.png");
	maps::mapTextures["de_anubis"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_anubis_radar.png");
	maps::mapTextures["de_dust2"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_dust2_radar.png");
	maps::mapTextures["de_inferno"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_inferno_radar.png");
	maps::mapTextures["de_mirage"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_mirage_radar.png");
	maps::mapTextures["de_nuke_lower"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_nuke_lower_radar.png");
	maps::mapTextures["de_nuke"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_nuke_radar.png");
	maps::mapTextures["de_overpass"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_overpass_radar.png");
	maps::mapTextures["de_vertigo_lower"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_vertigo_lower_radar.png");
	maps::mapTextures["de_vertigo"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_vertigo_radar.png");
	maps::mapTextures["de_train"] = LoadImageTexture(g_pd3dDevice, L".\\maps\\de_train_radar.png");
}
